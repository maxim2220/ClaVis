...
public class BazizucMenuFragment extends Fragment {
    private Integer[] id = {R.id.action_bazizucMenuFragment_to_promeshtochniiFragment, R.id.action_bazizucMenuFragment_to_promeshtochniiFragment, R.id.action_bazizucMenuFragment_to_promeshtochniiFragment,
            R.id.action_bazizucMenuFragment_to_promeshtochniiFragment, R.id.action_bazizucMenuFragment_to_promeshtochniiFragment
    };
